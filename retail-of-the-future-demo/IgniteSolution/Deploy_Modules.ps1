...
az iot edge deployment create --deployment-id retail_suite --hub-name $iotName --content .\config\deployment.remote.amd64.json  --target-condition "deviceId = 'retailASE'"