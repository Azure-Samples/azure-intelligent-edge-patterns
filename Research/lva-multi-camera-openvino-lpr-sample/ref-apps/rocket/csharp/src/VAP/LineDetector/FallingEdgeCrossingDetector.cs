...
namespace LineDetector
{
    class FallingEdgeCrossingDetector : ICrossingDetector
    {
        ...
        int UP_STATE_TRANSITION_LENGTH = LineDetectorConfig.UP_STATE_TRANSITION_LENGTH;
        int DOWN_STATE_TRANSITION_LENGTH = LineDetectorConfig.DOWN_STATE_TRANSITION_LENGTH;
        int History;
