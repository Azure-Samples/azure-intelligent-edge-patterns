...
from .hooks import (Hook, LrUpdaterHook, CheckpointHook, IterTimerHook, NumpySeedHook,
                    OptimizerHook, lr_updater)
from .priority import get_priority
from ..utils import (get_dist_info, get_host_info, get_time_str, obj_from_dict,
                     is_list_of, is_str, mkdir_or_exist, load_checkpoint, save_checkpoint)
...
class Runner(object):
    ...
    def save_checkpoint(self,
        ...
        save_checkpoint(self.model, linkname, optimizer=optimizer, meta=meta)
    ...
    def register_training_hooks(self,
        ...
        self.register_hook(NumpySeedHook())
