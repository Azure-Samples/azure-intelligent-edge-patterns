...
WEB_MODULE_VERSION=0.30.9
INFERENCE_MODULE_VERSION=0.30.9
RTSPSIM_MODULE_VERSION=0.30.9
CAMERA_MODULE_VERSION=0.30.9
NGINX_MODULE_VERSION=0.30.9
UPLOAD_MODULE_VERSION=0.30.9
PREDICT_MODULE_VERSION=0.30.9
MODELMANAGER_MODEULE_VERSION=0.30.9

DEV_REGISTRY=factoryairegistry

#DEV_VERSION=0.8.0
RELEASE_VERSION=0.30.9
