...
WEB_MODULE_VERSION=0.30.7
INFERENCE_MODULE_VERSION=0.30.7
RTSPSIM_MODULE_VERSION=0.30.7
CAMERA_MODULE_VERSION=0.30.7
NGINX_MODULE_VERSION=0.30.7
UPLOAD_MODULE_VERSION=0.30.7
PREDICT_MODULE_VERSION=0.30.7
MODELMANAGER_MODEULE_VERSION=0.30.7

DEV_REGISTRY=factoryairegistry

#DEV_VERSION=0.8.0
RELEASE_VERSION=0.30.7
