...
WEB_MODULE_VERSION=0.30.4
INFERENCE_MODULE_VERSION=0.30.4
RTSPSIM_MODULE_VERSION=0.30.4
CAMERA_MODULE_VERSION=0.30.4
NGINX_MODULE_VERSION=0.30.4
UPLOAD_MODULE_VERSION=0.30.4
PREDICT_MODULE_VERSION=0.30.4
MODELMANAGER_MODEULE_VERSION=0.30.4

DEV_REGISTRY=factoryairegistry

#DEV_VERSION=0.8.0
RELEASE_VERSION=0.30.4
