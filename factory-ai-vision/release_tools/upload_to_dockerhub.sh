...
WEB_MODULE_VERSION=0.30.6
INFERENCE_MODULE_VERSION=0.30.6
RTSPSIM_MODULE_VERSION=0.30.6
CAMERA_MODULE_VERSION=0.30.6
NGINX_MODULE_VERSION=0.30.6
UPLOAD_MODULE_VERSION=0.30.6
PREDICT_MODULE_VERSION=0.30.6
MODELMANAGER_MODEULE_VERSION=0.30.6

DEV_REGISTRY=factoryairegistry

#DEV_VERSION=0.8.0
RELEASE_VERSION=0.30.6
