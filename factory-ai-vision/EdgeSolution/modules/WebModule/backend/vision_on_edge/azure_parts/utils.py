...
def upload_part_to_customvision_helper(project_id,
    ...
    Args:
        ...
        part_id:
        tag_dict (dict):
            Tag dict from CustomVision. Not necessary
            unless db unsync with CustomVision. If no given,
            this function will get from api itself
...
def batch_upload_parts_to_customvision(project_id,
    ...
    for i, part_id in enumerate(part_ids):
        ...
        if part_created:
            has_new_parts = True
    logger.info("Creating/Update... Done")
