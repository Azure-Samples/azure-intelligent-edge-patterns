...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='camera',
            name='danger_zones',
            field=models.CharField(blank=True, default=gen_default_zones, max_length=1000),
        ),
        migrations.AlterField(
            model_name='camera',
            name='lines',
            field=models.CharField(blank=True, default=gen_default_lines, max_length=1000),
        ),
    ]
