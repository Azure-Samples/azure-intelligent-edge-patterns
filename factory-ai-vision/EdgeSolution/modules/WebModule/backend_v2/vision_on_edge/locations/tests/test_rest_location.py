...
class LocationRestTestCases(APITransactionTestCase):
    ...
    def setUp(self):
        ...
        data = {"name": "DemoLocation1", "description": "Desb1", "is_demo": True}
        self.client.post(url, data, format="json")

        data = {"name": "DemoLocation2", "description": "Desb1", "is_demo": True}
        self.client.post(url, data, format="json")

        data = {"name": "DemoLocation3", "description": "Desb1", "is_demo": True}
        self.client.post(url, data, format="json")
    ...
    def test_create_location_1(self):
        ...
        self.assertEqual(json.loads(response.content)["description"], location_desb)
        # Get location list
        response = self.client.get(url, format="json")
        ...
        self.assertEqual(Location.objects.get(name=location_name).name, location_name)
