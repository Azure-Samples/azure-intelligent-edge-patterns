...
class Stream:
        ...
        def _new_streaming(self):
            ...
            while self.cam_is_alive:
                ...
                if is_ok:
                    ...
                    self.restart_cam()
                    continue
            logger.warning("Stream {0} finished".format(self.cam_id))
            self.cam.release()
        ...
        def run_send(self):
            ...
            while self.cam_is_alive:
                ...
                if self.last_img is None:
                    logger.warning('stream {0} img not ready'.format(self.cam_id))
                    time.sleep(1)
                    continue
    ...
    def start_zmq(self):
        ...
        def run_send(self):
            ...
            while self.cam_is_alive:
                ...
                if cnt % 30 == 1:
                    logger.warning(
                        "send through channel {0} to inference server".format(
    ...
    def restart_cam(self):
        ...
        logger.warning("Restarting Cam {0}".format(self.cam_id))
